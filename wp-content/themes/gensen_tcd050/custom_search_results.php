...
?><!-- 「検索するボタン」を押したあとに表示されるページ -->
  <h2 class="headline rich_font">リゾートバイト<?php echo esc_html($dp_options['search_results_headline']); ?></h2>
<?php
	} else {
?>
...
?>
  <div class="archive_filter_headline rich_font"><span class="tag_headline"><?php _e('Refine Search', 'tcd-w'); ?></span><i class="far fa-caret-square-down"></i></div>
