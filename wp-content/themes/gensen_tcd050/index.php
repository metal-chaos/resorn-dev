...
<?php if (is_category()) { ?>
 <h2 id="archive_headline" class="headline rich_font"><?php echo single_cat_title('', false); ?>のリゾートバイト求人</h2>
<?php } elseif (is_tag() || is_tax($dp_options['introduce_tag_slug'])) { ?>
 <h2 id="archive_headline" class="headline rich_font"><?php echo single_tag_title('', false); ?>のリゾートバイト求人</h2>
...
<?php } elseif (is_month()) { ?>
 <h2 id="archive_headline" class="headline rich_font"><?php printf(__('Archive for &#8216; %s &#8217;', 'tcd-w'), get_the_time(__('F, Y', 'tcd-w'))); ?>aaa</h2>
...
?>
     ...
     <div class="r_score_sp" id=score<?php echo resorn_score(); ?> >
      ...
      <div class="r_score_text_sp"><span class="score<?php echo resorn_score(); ?>"><?php echo resorn_score(); ?></span> （最高は10）</div>
     </div>
     <table class="recruit_list">
      <tr>
       <th>会社</th>
       <td><img class="recruit_list_company" src="<?php echo do_shortcode('[company_image]'); ?>"></td>
      </tr>
      <tr>
       <th>職種</th>
       <td><?php echo esc_html( $post->occupation_field ); ?></td>
      </tr>
      <tr>
       <th>給与</th>
       <td><?php echo wp_strip_all_tags(salary_fi()); ?></td>
      </tr>
     </table>
     <div class="navigation2_icons">
       <img class="<?php echo esc_html( $post->icon_dormitory_field ); ?>" src="https://resorn.net/wp-content/uploads/2018/02/new-koshitsuryo-1.png">
       <img class="<?php echo esc_html( $post->icon_highIncome_field ); ?>" src="https://resorn.net/wp-content/uploads/2018/02/new-koshunyu-1.png">
       <img class="<?php echo esc_html( $post->icon_campaign_field ); ?>" src="https://resorn.net/wp-content/uploads/2018/02/new-campaign-1.png">
       <img class="<?php echo esc_html( $post->icon_meal_field ); ?>" src="https://resorn.net/wp-content/uploads/2018/02/new-shokuji-1.png">
       <img class="<?php echo esc_html( $post->icon_transportationFee_field ); ?>" src="https://resorn.net/wp-content/uploads/2018/02/new-carloan-1.png">
       <img class="<?php echo esc_html( $post->icon_wifi_field ); ?>" src="https://resorn.net/wp-content/uploads/2018/02/new-wifi-1.png">
       <img class="<?php echo esc_html( $post->icon_spa_field ); ?>" src="https://resorn.net/wp-content/uploads/2018/02/new-spa-1.png">
     </div>
