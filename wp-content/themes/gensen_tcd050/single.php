    ...
    <div id="article">
      ...
      <div id="article_header">
        ...
        if ($dp_options['show_categories']) {
            ...
            if ($metas) {
                ?>
        <ul id="post_meta_top" class="meta clearfix"><?php echo implode('', $metas); ?>
        </ul>
        <?php
            }
        }
?>
        ...
        <h2 id="post_title" class="rich_font"><?php the_title(); ?>
        </h2>

        <?php if ($dp_options['show_date']) {
    ?>
        <div id="post_date"><time class="entry-date updated"
            datetime="<?php the_modified_time('c'); ?>"><?php if ($dp_options['show_modified_date']) {
        the_time('Y.m.d');
        echo ' / ';
        _e('Last modified at ', 'tcd-w');
      ...
      <?php
       ...
       if (!is_mobile()) {
           if ($dp_options['single_ad_code5'] || $dp_options['single_ad_image5'] || $dp_options['single_ad_code6'] || $dp_options['single_ad_image6']) {
               ?>
      <div id="single_banner_area_bottom" class="clearfix<?php if (!$dp_options['single_ad_code6'] && !$dp_options['single_ad_image6']) {
                   echo ' one_banner';
               } ?>">
        ...
        <div class="single_banner single_banner_left">
          <a href="<?php esc_attr_e($dp_options['single_ad_url5']); ?>"
            target="_blank"><img
              src="<?php echo $single_image5[0]; ?>" alt=""
              title="" /></a>
        </div>
        <?php
               } ?>
        ...
        <div class="single_banner single_banner_right">
          <a href="<?php esc_attr_e($dp_options['single_ad_url6']); ?>"
            target="_blank"><img
              src="<?php echo $single_image6[0]; ?>" alt=""
              title="" /></a>
        </div>
        <?php
               } ?>
      ...
      <div id="single_banner_area_bottom" class="clearfix one_banner">
        ...
        <div class="single_banner single_banner_left">
          <a href="<?php esc_attr_e($dp_options['single_mobile_ad_url1']); ?>"
            target="_blank"><img
              src="<?php echo $single_image1[0]; ?>" alt=""
              title="" /></a>
        </div>
        <?php
           } ?>
...
?>
      ...
      <div class="post_content clearfix">
        ...
        -->
        <?php require_once "job-detail/article.php"; ?>
    ...
    ?>
      ...
      <ul id="post_meta_bottom" class="clearfix">
        <?php if ($dp_options['show_author']) : ?>
        <li class="post_author"><?php _e("Author", "tcd-w"); ?>:
        ...
        <?php if ($dp_options['show_comment']) : if (comments_open()) {
            ?>
        <li class="post_comment"><?php _e("Comment", "tcd-w"); ?>:
          <a href="#comment_headline"><?php comments_number('0', '1', '%'); ?></a>
        </li><?php
        }
        endif; ?>
      </ul>
    ...
    <?php
      ...
      if (!is_mobile()) {
          if ($dp_options['single_ad_code1'] || $dp_options['single_ad_image1'] || $dp_options['single_ad_code2'] || $dp_options['single_ad_image2']) {
              ?>
    <div id="single_banner_area" class="clearfix<?php if (!$dp_options['single_ad_code2'] && !$dp_options['single_ad_image2']) {
                  echo ' one_banner';
              } ?>">
      ...
      <div class="single_banner single_banner_left">
        <a href="<?php esc_attr_e($dp_options['single_ad_url1']); ?>"
          target="_blank"><img src="<?php echo $single_image1[0]; ?>"
            alt="" title="" /></a>
      </div>
      <?php
              } ?>
      ...
      <div class="single_banner single_banner_right">
        <a href="<?php esc_attr_e($dp_options['single_ad_url2']); ?>"
          target="_blank"><img src="<?php echo $single_image2[0]; ?>"
            alt="" title="" /></a>
      </div>
      <?php
              } ?>
    ...
    <div id="single_banner_area" class="clearfix one_banner">
      ...
      <div class="single_banner single_banner_left">
        <a href="<?php esc_attr_e($dp_options['single_mobile_ad_url2']); ?>"
          target="_blank"><img src="<?php echo $single_image2[0]; ?>"
            alt="" title="" /></a>
      </div>
      <?php
      ...
      if ($dp_options['show_related_post']) :
        ...
        if (!empty($args['tax_query'])) {
            ...
            if ($my_query->have_posts()) {
                ?>
    <div id="related_post">
      <h3 class="headline rich_font"><?php echo esc_html($dp_options['related_post_headline']); ?>
      </h3>
      <ol class="clearfix">
          ...
          <a href="<?php the_permalink() ?>">
            <div class="image">
              <?php if (has_post_thumbnail()) {
                        ...
                        echo '<img src="'.get_template_directory_uri().'/img/common/no_image2.gif" alt="" title="" />';
                    } ?>
            </div>
            <h4 class="title js-ellipsis"><?php the_title(); ?>
            </h4>
          </a>
        </li>
        <?php
