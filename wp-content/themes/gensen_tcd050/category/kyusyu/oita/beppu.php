...
<img class="archive_heading_banner"
    src="<?php  echo $upload_dir['baseurl']; ?>/categories/kyusyu/oita/beppu/beppu-onsen.jpg"
...
<div class="inner">
    ...
    <div class="archive_row">
        <div class="archive_col archive_col-3">
            <h4>別府地獄めぐり</h4>
            <img src="<?php  echo $upload_dir['baseurl']; ?>/categories/kyusyu/oita/beppu/chinoike-jigoku.jpg"
                alt="別府地獄めぐり">
        ...
        <div class="archive_col archive_col-3">
            <h4>明礬温泉</h4>
            <img src="<?php  echo $upload_dir['baseurl']; ?>/categories/kyusyu/oita/beppu/myouban-onsen.jpg"
                alt="明礬温泉">
        ...
        <div class="archive_col archive_col-3">
            <h4>鉄輪温泉</h4>
            <img src="<?php  echo $upload_dir['baseurl']; ?>/categories/kyusyu/oita/beppu/kannawa-onsen.jpg"
                alt="鉄輪温泉">
