            ...
            <div class="res-dis-none">
                ...
                <div class="post_row">
                    <div class="post_col post_col-3">
                        ...
                        <p>RESORN（リゾーン）では、驚くことに5,000件以上もの求人を掲載しています。トップレベルの求人数を誇るRESORNで仕事を探してみましょう。</p>
                    </div>
                    <div class="post_col post_col-3">
                        <h3>平均時給</h3>
                        <div class="top-icons">
                        ...
                        <p>北は北海道から南は沖縄まで、日本全国の地域検索に対応しています。スキーや温泉、南国の海など目的別の求人探しができる優れた検索機能を有しています。</p>
                    </div>
                    <div class="post_col post_col-3">
                        <h3>最高時給</h3>
                        <div class="top-icons">
                ...
                <div class="post_col post_col-4">
                    <div class="top-icons">
                        <div class="for-sp-icon">
                            <h3>①個室寮付き求人</h3>
                            <img class="top-icon" src="<?php echo $upload_dir['baseurl']; ?>/top/todays-resorn/graph-test.png">
                        </div>
                    </div>
